...
function Home() {
  return (
    ...
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  text-white text-7xl font-medium rounded-box w-52">
        <li><a href="#">Home ()</a></li>
      ...
      <div className="Aboutsection ml-28" id='about'>
        <About />
      </div>
    {/*   hr line */} 
      ...
      <div className="credentialsection ml-28">
       ...
       <p className="text-center text-slate-500 text-xl font-semibold mt-3">What I will do for you?</p>
