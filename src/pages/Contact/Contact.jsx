...
function Contact() {
  return (
    <div className="mt-6 ">
      ...
      {/* From start */}
      <form
        action="mailto:chakrabortyshuva216@gmail.com"
        method="post"
        class=" mr-16 rounded px-8 pt-6 pb-8 mb-4"
      >
        <div class="mb-4">
          <label
        ...
        <div class="mb-4">
          ...
          <textarea
            className="border-b-2 w-full border-slate-600"
            id=""
            name=""
            rows="4"
            cols="50"
        ...
        <div class="">
          <button
            class="bg-slate-700 hover:bg-slate-900 text-white font-semibold py-2 px-5 rounded focus:outline-none focus:shadow-outline"
            type="submit"
            value="Send"
          >
            SEND
