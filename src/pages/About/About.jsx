...
<p className='mb-3'>Currently, I am expanding my skill set by learning WordPress and PHP. These technologies are popular for building dynamic and robust web applications, and I am excited to apply my knowledge and experience to create high-quality websites for my clients.</p>
<p className='mb-3'>With strong attention to detail and a focus on delivering exceptional user experiences, I am committed to staying up-to-date with the latest trends and best practices in front-end development. I am always seeking new challenges and opportunities to expand my skills and contribute to the success of my clients.</p>
<p className='mb-3'>If you are looking for a front-end developer with a proven track record of delivering high-quality work and exceptional user experiences, please feel free to contact me. I am open to new opportunities and collaborations.</p>
</div>
    </div>
  )
}
