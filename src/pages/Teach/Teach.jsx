      ...
      <div className="main flex flex-row">
        <div className="1 ">
          ...
          <div className="flex flex-row mb-3">
            ...
            <div className="ml-2">HTML5</div>
          </div>
          <div className="flex flex-row mb-3">
            <div>
              <img src={css} />
            </div>
            <div className="ml-2">CSS3</div>
          </div>
          <div className="flex flex-row mb-3">
            <div>
              <img src={c} />
        ...
        <div className="2 ml-96">
          ...
          <div className="flex flex-row mb-3">
            ...
            <div className="ml-2">Vite Js</div>
          </div>
          <div className="flex flex-row mb-3">
            <div>
              <img src={next} width="30" height="25" />
            </div>
            <div className="ml-2">Next js</div>
          </div>
          <p className="text-slate-500 text-lg mt-14 mb-4">
            CSS Pre-processors
          </p>
