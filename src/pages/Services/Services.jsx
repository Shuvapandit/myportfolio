...
function Services() {
  ...
  <figure class="px-10 pt-10">
    <img src={html} width="40" height="40" alt="psdtohtml" class="rounded-xl" />
  </figure>
  <div class="card-body items-center text-center">
    ...
    <p>I will convert your PSD to HTML5 with Latest Bootstrap. It will be fully responsive. Pixel-perfect code and fresh hand code are my power. If you have any design or idea I can make it a website.</p>
        ...
        <div class="card w-80 bg-base-100 shadow-2xl hover:bg-blue-50">
  <figure class="px-10 pt-10">
    <img src={frontend} width="50" height="50" alt="psdtohtml" class="rounded-xl" />
  </figure>
  <div class="card-body items-center text-center">
    ...
    <p>I’m a Front End Web developer who is passionate about making error-free websites with 100% client satisfaction.</p>
        ...
        <div class="card w-80 bg-base-100 shadow-2xl hover:bg-blue-50">
  <figure class="px-10 pt-10">
    <img src={html} width="50" height="50" alt="psdtohtml" class="rounded-xl" />
  </figure>
  <div class="card-body items-center text-center">
    <h2 class="card-title">REACT JS DEVELOPER</h2>
    <p className=''>As a React.js developer, I build efficient and dynamic user interfaces with reusable components, delivering seamless web experiences.</p>
  </div>
</div>
        </div>
        </div>   
